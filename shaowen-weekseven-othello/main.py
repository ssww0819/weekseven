    ...
    def pickMove(self, g):
    	...
    	if len(valid_moves) == 0:
    		...
    		# Chooses a valid move randomly if available.
                ...
                scoreboard = [[100, 10, 80, 70, 70, 80, 10, 100],
                              [10, 15, 30, 60, 60, 30, 15, 10],
                              [80, 30, 60, 40, 40, 60, 30, 80],
                              [70, 60, 40, 0, 0, 40, 60, 70],
                              [70, 60, 40, 0, 0, 40, 60, 70],
                              [80, 30, 60, 40, 40, 60, 30, 80],
                              [10, 15, 30, 60, 60, 30, 15, 10],
                              [100, 10, 80, 70, 70, 80, 10, 100]]
                               
                move = random.choice(valid_moves)
                maxscore = -1
                for item in valid_moves:
                        if scoreboard[item['Where'][0] - 1][item['Where'][1] - 1] > maxscore:
                                maxscore = scoreboard[item['Where'][0]-1][item['Where'][1]-1]
                                move = item
                        #elif scoreboard[item[0], item[1]] == maxscore:
